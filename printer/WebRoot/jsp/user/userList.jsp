  ...
  <head>
	...
	function loadList() {
		...
		$("#dataTable").datagrid({
				...
				columns:[[
					{field:'account',title:'帐号',width:100,rowspan:2,sortable:true,
						sorter:function(a,b){
							return (a>b?1:-1);
						}
					},
					...
					{field:'phone',title:'联系电话',width:200,rowspan:2,sortable:true,
					    sorter:function(a,b){
							return (a>b?1:-1);
						}
					},
					{field:'entername',title:'乡镇单位',width:200,rowspan:2,sortable:true,
						sorter:function(a,b){
							return (a>b?1:-1);
						}
					},
					...
					{field:'opt',title:'操作',width:200,align:'center',  
		                 		formatter:function(value,rowData,rowIndex){  
				                    if(rowData.uuid!=""){
					                      var e = '<a href="toEditUser.action?id='+rowData.id+'"  >编辑</a>  ';  
	...
	function toAdd(){
        ...
        formObj.action="userToAdd.action";
        formObj.submit(); 
	} 
