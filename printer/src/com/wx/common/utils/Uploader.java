...
public class Uploader {
	...
	public void uploadBase64(String fieldName){
		if (logger.isDebugEnabled()) {
			logger.debug("uploadBase64(String) - start"); //$NON-NLS-1$
		}
		...
		try {
			...
			logger.error("uploadBase64(String)", e); //$NON-NLS-1$

			this.state = this.errorInfo.get("IO");
		}

		if (logger.isDebugEnabled()) {
			logger.debug("uploadBase64(String) - end"); //$NON-NLS-1$
		}
	}
	...
	private String getFileExt(String fileName) {
		...
		String returnString = fileName.substring(fileName.lastIndexOf("."));
		if (logger.isDebugEnabled()) {
	...
	private String getName(String fileName) {
		...
		String returnString = this.fileName = "" + random.nextInt(10000) + System.currentTimeMillis() + this.getFileExt(fileName);
		if (logger.isDebugEnabled()) {
	...
	private String getFolder(String path) {
		...
		if (!dir.exists()) {
			try {
				...
				logger.error("getFolder(String)", e); //$NON-NLS-1$
