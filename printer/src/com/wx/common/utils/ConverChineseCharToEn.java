...
public class ConverChineseCharToEn {
	...
	public static boolean isNumeric(String str) {
		...
		boolean returnboolean = pattern.matcher(str).matches();
	...
	public static String converEnToNumber(String str) {
		...
		String returnString = sbf.toString();
	...
	public static String replaceString(String chines) {
		...
		String returnString = chines.replace("《", "").replace("》", "").replace("！", "").replace("￥", "").replace("【", "").replace("】", "").replace("（", "").replace("）", "").replace("－", "").replace("；", "").replace("：", "").replace("”", "").replace("“", "").replace("。", "").replace("，", "").replace("、", "").replace("？", "").replace(" ", "").replace("-", "");
	...
	public static String converterToPingYingHeadUppercase(String chines) {
		...
		String pinyin=pinyinName.toString();
		
		String returnString = pinyin.replace("u:", "v");
	...
	public static String converterToAllFirstSpellsUppercase(String chines) {
		...
		String returnString = pinyinName.toString();
		return returnString;
	}
	...
	public static boolean isEng(String str) {
		...
		if (str != null && str.length() > 0) {
			boolean returnboolean = str.charAt(0) >= 0x0000 && str.charAt(0) <= 0x00ff;
			return returnboolean;
		} else {
			return false;
		}
